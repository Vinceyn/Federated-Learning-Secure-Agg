 ...
 */
 ...
 /**
  * Perform the different benchmarks shown in the report
  */
 async function benchmarks() {

     await benchmarksWithoutDropouts(5, 51, 5, 10, 0)
     await benchmarksWithDropouts(5, 51, 5, 0.2, 0.61, 0.2, 10, 0)
 
     await benchmarksWithoutDropouts(20, 201, 20, 2, 1)
     await benchmarksWithDropouts(20, 201, 20, 0.2, 0.61, 0.2, 2, 1)
